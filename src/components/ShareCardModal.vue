    ...
    <div class="modal-content share-modal-content">
      ...
      <div id="share-card-node" class="share-card-wrapper">
        <div class="share-card-header">
          ...
          <span class="share-tag">星座与星盘解析</span>
        </div>
        ...
        <div class="share-card-footer">
          <div class="share-qrcode-area">
            ...
            <div class="share-tip-text">
              <span class="primary">扫码体验 AI 星座运势与星盘解析助手</span>
...
// 清理回复末尾的特殊标记 [XINGZUO_SCORES]...[/XINGZUO_SCORES]
const cleanContent = computed(() => {
  if (!props.content) return '';
  return props.content.replace(/\[XINGZUO_SCORES\][\s\S]*?\[\/XINGZUO_SCORES\]/gi, '').trim();
});
...
const handleCopy = async () => {
  try {
    const textToCopy = `【网腾无限AI - 星座运势与星盘心理解析】\n\n${cleanContent.value}\n\n体验星盘运势AI助手：https://ai.wuxian.xyz`;
